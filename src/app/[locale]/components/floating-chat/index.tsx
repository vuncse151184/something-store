...
import { Flower2, X, Minimize2, FlowerIcon } from "lucide-react"
        ...
        <>
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ref={chatRef}
                        id="chat-panel"
                        className={`fixed z-50 bg-gray-900 rounded-lg shadow-xl overflow-hidden flex flex-col border border-gray-800 ${isMobile ? "inset-x-4 bottom-20 top-20" : "bottom-24 right-24 w-[400px] h-[500px]"
                            }`}
            ...
            >
                <Button
                    ...
                    onClick={toggleChat}
                    size="lg"
                    className={`rounded-full w-14 h-14 shadow-lg relative bg-gradient-to-r from-purple-700 to-pink-600 hover:from-purple-800 hover:to-pink-700 border-none`}
